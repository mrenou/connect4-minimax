...
@Ignore
public class PlayerAlphabetaWithStateV2Test {
    ...
    public void should_always_win_vs_player_easy() {
        ...
        for (int i = 0; i < NB_MATCHES;i++) {
            Player player1 = new PlayerAlphabetaWithStateV2();
    ...
    @Test
    public void should_always_win_vs_player_alphabeta_with_state_v1() {
    ...
    public void should_always_loose_vs_player_alphabeta_with_state_v3() {
        ...
        for (int i = 0; i < NB_MATCHES; i++) {
            ...
            assertThat(match.play()).isNotEqualTo(player1);
        }
    }
}
