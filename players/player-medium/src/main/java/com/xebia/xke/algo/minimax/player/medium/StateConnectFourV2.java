...
public class StateConnectFourV2 extends StateConnectFour {

    private enum LineType {
        VERTICAL, HORIZONTAL, DIAGONAL_ASC, DIAGONAL_DES
    }

    public StateConnectFourV2(Board boardCloned, CounterColor counterColorTested, CounterColor counterColorToPlay, int columnIndexPlayed, int maxDepth) {
            ...
            for (; verticalIndex < board.getColumnSize() && columnIndex < board.getNbColumns(); verticalIndex++, columnIndex++) {
                ...
                if (board.isEmpty(columnIndex, verticalIndex) == false) {
                    if (scoringCounterColor == null || board.hasCounterColor(columnIndex, verticalIndex, scoringCounterColor) == false) {
                        ...
                        lineSize++;
                        if (lineSize == 4) {
                            if (scoringCounterColor.equals(counterColorTested)) {
                    ...
                    if (board.isEmpty(columnIndex - 1, verticalIndex - 1) == true) {
                        startWithEmpty = true;
                    }
                    if (board.isEmpty(columnIndex + 1, verticalIndex + 1) == true) {
                        endWithEmpty = true;
        ...
        for (int verticalIndex = 0; verticalIndex < board.getColumnSize(); verticalIndex++) {
            ...
            for (int columnIndex = 0; columnIndex < board.getNbColumns(); columnIndex++) {
                ...
                if (board.isEmpty(columnIndex, verticalIndex) == false) {
                    ...
                    if (board.isEmpty(columnIndex - 1, verticalIndex) == true) {
                        startWithEmpty = true;
                    }
                    if (board.isEmpty(columnIndex + 1, verticalIndex) == true) {
                        endWithEmpty = true;
        ...
        for (int columnIndex = 0; columnIndex < board.getNbColumns(); columnIndex++) {
            ...
            for (int verticalIndex = 0; verticalIndex < board.getColumnSize(); verticalIndex++) {
                ...
                if (board.isEmpty(columnIndex, verticalIndex) == false) {
                    ...
                    if (board.isEmpty(columnIndex, verticalIndex - 1) == true) {
                        startWithEmpty = true;
                    }
                    if (board.isEmpty(columnIndex, verticalIndex + 1) == true) {
                        endWithEmpty = true;
    ...
    protected StateConnectFour createNextState(Board boardCloned, CounterColor counterColorTested, CounterColor counterColorToPlay, int columnIndexPlayed, int maxDepth) {
        return new StateConnectFourV2(boardCloned, counterColorTested, counterColorToPlay, columnIndexPlayed, maxDepth);
    }
}
