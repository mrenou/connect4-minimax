...
public class StateConnectFourV4Test {
    ...
    @Test
    public void someTests2() {

        EvalBoardTester evalBoardTester = new EvalBoardTester() {
            @Override
            protected int computeScore(Board board) {
                StateConnectFourV4 stateConnectFourV4 = new StateConnectFourV4(board, CounterColor.RED, CounterColor.YELLOW, 1, 3);
                return stateConnectFourV4.getScore();
